...
/// Reports what [`remove_cell_edit`] would do to this cell, without doing it.
///
...
/// Reports whether [`remove_cell_edit`] would accept this cell.
...
///
/// This is the standalone form of [`remove_cell_edit`] and carries the same
...
pub fn remove_cell<P: Payload>(
    ...
    g.transaction(|edit| remove_cell_edit(edit, dart, dim))
}
