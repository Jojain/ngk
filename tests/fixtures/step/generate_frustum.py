"""Regenerates frustum.step in this directory.

Run with `uv run python tests/fixtures/step/generate_frustum.py` from the
...
bd.export_step(frustum, "tests/fixtures/step/frustum.step")
