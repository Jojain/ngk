"""Regenerates torus.step in this directory.

Run with `uv run python tests/fixtures/step/generate_torus.py` from the
...
torus = bd.Torus(3, 1)
bd.export_step(torus, "tests/fixtures/step/torus.step")
