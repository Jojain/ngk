"""Regenerates holed_slab.step in the sibling `files/` directory.
...
Run with `uv run python tests/exchange/foreign/generate/generate_holed_slab.py`
...
bd.export_step(slab, "tests/exchange/foreign/files/holed_slab.step")
